...
public class MessageViewInfoExtractor {
    ...
    public static MessageViewInfo extractMessageForView(Context context,
        ...
        ViewableExtractedText extraViewable = extractViewableAndAttachments(context, extraParts, attachmentInfos);

        return new MessageViewInfo(message, rootPart, viewable.html,
                attachmentInfos, cryptoResultAnnotation, extraViewable.text, extraAttachmentInfos);
    }
